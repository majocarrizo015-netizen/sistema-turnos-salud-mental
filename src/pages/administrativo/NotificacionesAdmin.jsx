...
function NotifCard({ n, onClick }) {
  ...
  return (
    <button
      onClick={() => onClick(n)}
      className={`w-full text-left p-4 rounded-lg border transition-colors ${n.leida ? 'bg-white border-border' : 'bg-administrativo-light border-administrativo-primary/30'}`}
    >
