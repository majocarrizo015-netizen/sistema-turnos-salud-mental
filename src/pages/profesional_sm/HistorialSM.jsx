      ...
      <div className="max-w-2xl mx-auto px-4 py-4">
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-border bg-white text-sm text-text-primary outline-none focus:border-profesional-sm-primary"
          />
        </div>
            ...
            {filtered.map(s => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl border border-border p-4 cursor-pointer hover:border-profesional-sm-primary transition-colors"
                >
